    ...
    <div class="container">
        <div class="row">
            <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-primary d-flex justify-content-between">
                <a class="navbar-brand text-uppercase" href="main.html">Gestor Energético</a>
                ...
                <div class="collapse navbar-collapse" id="menu">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <h5><a class="nav-link dropdown-toggle" href="control.html" data-toggle="dropdown">Control</a></h5>
                        ...
                        <li class="nav-item dropdown">
                            <h5><a class="nav-link dropdown-toggle" href="registro.html" data-toggle="dropdown">Registro</a></h5>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#">Arduino #1</a>
                                <a class="dropdown-item" href="#">Arduino #2</a>
                                <a class="dropdown-item" href="#">Arduino #3</a>
